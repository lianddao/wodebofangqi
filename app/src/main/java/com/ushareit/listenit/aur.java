...
class aur implements aud {
    ...
    public Bitmap mo803a(Bitmap bitmap, float f) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                arrayList.add(new aus(iArr, width, height, (int) f, i, i2, 1));
                arrayList2.add(new aus(iArr, width, height, (int) f, i, i2, 2));
            }
            try {
                atc.f5401b.invokeAll(arrayList);
                try {
                    atc.f5401b.invokeAll(arrayList2);
                    try {
