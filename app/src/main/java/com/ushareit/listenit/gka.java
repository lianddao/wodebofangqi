...
public class gka extends gkf {
    ...
    public void mo2691j() {
        ...
        m22127a(confirmPopupView);
        confirmPopupView.setConfirmListener(new gkb(this, confirmPopupView));
        m20825a((BasePopupView) confirmPopupView);
    }

    private void m22127a(ConfirmPopupView confirmPopupView) {
        String string;
        String string2;
    ...
    private void m22128a(boolean z, glg com_ushareit_listenit_glg) {
        if (gyn.m23260p(com_ushareit_listenit_glg.f14342j)) {
            m22126a(com_ushareit_listenit_glg);
        } else {
            m22131b(z, com_ushareit_listenit_glg);
        }
    }

    private void m22129a(boolean z, List<glg> list) {
    ...
    private void m22131b(boolean z, glg com_ushareit_listenit_glg) {
        if (z) {
        ...
        fre.m20626a(com_ushareit_listenit_glg, false);
    }

    private void m22132b(boolean z, List<glg> list) {
        if (z) {
    ...
    private void m22126a(glg com_ushareit_listenit_glg) {
        fre.m20626a(com_ushareit_listenit_glg, false);
    }

    private void m22130b(List<glg> list) {
        for (glg a : list) {
            fre.m20626a(a, false);
        }
    }
    ...
    public void mo2694k() {
        ...
        if (com_ushareit_listenit_glg != null) {
            ...
            confirmPopupView.setConfirmListener(new gkc(this, com_ushareit_listenit_glg));
