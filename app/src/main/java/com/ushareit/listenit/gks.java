...
public class gks extends gkf {
    ...
    public void mo2691j() {
        ...
        m22229a(confirmPopupView);
        confirmPopupView.setConfirmListener(new gkt(this, confirmPopupView));
        m20825a(confirmPopupView);
    }

    private void m22229a(ConfirmPopupView confirmPopupView) {
        String string;
        String string2;
        ...
        if (size == 1) {
            ...
            string = m20847s().getResources().getString(C0349R.string.confirm_view_delete_songs_title, new Object[]{Integer.valueOf(size)});
        }
        if (size == 1) {
    ...
    private void m22230a(boolean z, glg com_ushareit_listenit_glg) {
    ...
    private void m22231a(boolean z, List<glg> list) {
    ...
    public void mo2694k() {
        ...
        if (com_ushareit_listenit_glg != null) {
            ...
            confirmPopupView.setConfirmListener(new gku(this, com_ushareit_listenit_glg));
            m20825a(confirmPopupView);
        }
    }
