...
public class fpi extends fpm {
    ...
    public void mo2513a(File file) {
        ...
        this.f13173a = 0;
        this.f13180m = 64;
        this.f13174b = new int[this.f13180m];
        this.f13175h = new int[this.f13180m];
        this.f13176i = new int[this.f13180m];
        this.f13181n = 1000000000;
        this.f13182o = 0;
        this.f13178k = 10;
        this.f13179l = 0;
        this.f13177j = (int) this.g.length();
        if (this.f13177j < 128) {
        ...
        this.f13179l += 6;
        if (bArr[0] == (byte) 35 && bArr[1] == (byte) 33 && bArr[2] == (byte) 65 && bArr[3] == (byte) 77 && bArr[4] == (byte) 82 && bArr[5] == (byte) 10) {
            m20293a(fileInputStream, this.f13177j - 6);
        }
        fileInputStream.read(bArr, 6, 6);
        this.f13179l += 6;
        if (bArr[4] == (byte) 102 && bArr[5] == (byte) 116 && bArr[6] == (byte) 121 && bArr[7] == (byte) 112 && bArr[8] == (byte) 51 && bArr[9] == (byte) 103 && bArr[10] == (byte) 112 && bArr[11] == (byte) 52) {
            int i = (bArr[3] & 255) | ((((bArr[0] & 255) << 24) | ((bArr[1] & 255) << 16)) | ((bArr[2] & 255) << 8));
            if (i >= 4 && i <= this.f13177j - 8) {
                fileInputStream.skip((long) (i - 12));
                this.f13179l += i - 12;
            }
            m20288b(fileInputStream, this.f13177j - i);
        }
    }

    private void m20288b(InputStream inputStream, int i) {
        if (i >= 8) {
            ...
            if (i2 <= i && i2 > 0) {
                if (bArr[4] == (byte) 109 && bArr[5] == (byte) 100 && bArr[6] == (byte) 97 && bArr[7] == (byte) 116) {
                    m20293a(inputStream, i2);
                    return;
                }
                inputStream.skip((long) (i2 - 8));
                this.f13179l += i2 - 8;
                m20288b(inputStream, i - i2);
            }
        }
    }

    void m20293a(InputStream inputStream, int i) {
        int i2;
        int i3 = 0;
        int[] iArr = new int[4];
        for (i2 = 0; i2 < 4; i2++) {
        ...
        i2 = i;
        while (i2 > 0) {
            int a = m20289a(inputStream, i2, iArr);
            i3 += a;
            i2 -= a;
    ...
    int m20289a(InputStream inputStream, int i, int[] iArr) {
        int i2 = this.f13179l;
        ...
        switch (i3) {
            case 0:
                this.f13178k = 5;
                iArr3 = new int[4];
                iArr3[2] = (iArr2[43] * 128) + (((((((iArr2[32] * 1) + (iArr2[33] * 2)) + (iArr2[34] * 4)) + (iArr2[35] * 8)) + (iArr2[40] * 16)) + (iArr2[41] * 32)) + (iArr2[42] * 64));
                iArr3[3] = iArr3[2];
                for (i4 = 0; i4 < 4; i4++) {
                    i8 = f13170t[((iArr3[i4] * 4) + ((i4 & 1) * 2)) + 1];
                    double log = Math.log((double) i8) / Math.log(2.0d);
                    i7 = (int) log;
                    i7 = (((((i7 - 12) * 49320) + (((((int) ((log - ((double) i7)) * 32768.0d)) * 24660) >> 15) * 2)) * 8192) + 32768) >> 16;
                    i3 = ((((385963008 + (iArr[0] * 5571)) + (iArr[1] * 4751)) + (iArr[2] * 2785)) + (iArr[3] * 1556)) >> 15;
                    iArr[3] = iArr[2];
                    iArr[2] = iArr[1];
                    iArr[1] = iArr[0];
                    iArr[0] = i7;
                    m20290a(i2, i5 + 1, (i8 * i3) >> 24);
                }
                break;
            case 1:
                this.f13178k = 5;
                iArr3 = new int[4];
                iArr3[0] = (((((iArr2[24] * 1) + (iArr2[25] * 2)) + (iArr2[26] * 4)) + (iArr2[36] * 8)) + (iArr2[45] * 16)) + (iArr2[55] * 32);
                iArr3[1] = (((((iArr2[27] * 1) + (iArr2[28] * 2)) + (iArr2[29] * 4)) + (iArr2[37] * 8)) + (iArr2[46] * 16)) + (iArr2[56] * 32);
                iArr3[2] = (((((iArr2[30] * 1) + (iArr2[31] * 2)) + (iArr2[32] * 4)) + (iArr2[38] * 8)) + (iArr2[47] * 16)) + (iArr2[57] * 32);
                iArr3[3] = (iArr2[58] * 32) + (((((iArr2[33] * 1) + (iArr2[34] * 2)) + (iArr2[35] * 4)) + (iArr2[39] * 8)) + (iArr2[48] * 16));
                for (i4 = 0; i4 < 4; i4++) {
                    i8 = ((((385963008 + (iArr[0] * 5571)) + (iArr[1] * 4751)) + (iArr[2] * 2785)) + (iArr[3] * 1556)) >> 15;
                    i7 = f13168r[iArr3[i4]];
                    i3 = f13167q[iArr3[i4]];
                    iArr[3] = iArr[2];
                    iArr[2] = iArr[1];
            ...
            case 7:
                ...
                m20294a(iArr2, iArr3, iArr4, iArr5, iArr6);
                int i9 = 0;
                int i10 = 0;
                while (i9 < 4) {
                    int i11;
                    ...
                    for (i8 = 0; i8 < 5; i8++) {
                        if (((iArr6[i9][i8] >> 3) & 1) == 0) {
                            i4 = 4096;
                        } else {
                            i4 = -4096;
                        }
                        i11 = (f13171u[iArr6[i9][i8] & 7] * 5) + i8;
                        int i12 = (f13171u[iArr6[i9][i8 + 5] & 7] * 5) + i8;
                        iArr7[i11] = i4;
                        if (i12 < i11) {
                            i4 = -i4;
                        }
                        iArr7[i12] = i4 + iArr7[i12];
                    }
                    i11 = iArr3[i9];
                    if (i9 != 0 && i9 != 2) {
                        i4 = 18;
                    ...
                    i8 = (f13172v[iArr4[i9]] >> 2) << 2;
                    if (i8 > 16383) {
                        i8 = 32767;
                    } else {
                        i8 *= 2;
                    }
                    for (i10 = i4; i10 < 40; i10++) {
                        iArr7[i10] = iArr7[i10] + ((iArr7[i10 - i4] * i8) >> 15);
                    }
                    i10 = 0;
                    for (i8 = 0; i8 < 40; i8++) {
                        i10 += iArr7[i8] * iArr7[i8];
                    }
                    if (1073741823 <= i10 || i10 < 0) {
                        i8 = MoPubClientPositioning.NO_REPEAT;
                    } else {
                        i8 = i10 * 2;
                    }
                    double log2 = Math.log((double) (((i8 + 32768) >> 16) * 52428)) / Math.log(2.0d);
                    i8 = (int) log2;
                    i8 = (((((((iArr[0] * 44) + (iArr[1] * 37)) + (iArr[2] * 22)) + (iArr[3] * 12)) * 2) + 783741) - (((i8 - 30) << 16) + (((int) ((log2 - ((double) i8)) * 32768.0d)) * 2))) / 2;
                    i10 = i8 >> 16;
                    i8 = (int) (Math.pow(2.0d, ((double) i10) + (((double) ((i8 >> 1) - (i10 << 15))) / 32768.0d)) + 0.5d);
                    if (i8 <= 2047) {
                        i8 <<= 4;
                    } else {
                        i8 = 32767;
                ...
                break;
            default:
                System.out.println("Unsupported frame type: " + i3);
                m20290a(i2, i5 + 1, 1);
                break;
        }
        return i5 + 1;
    ...
    void m20290a(int i, int i2, int i3) {
        this.f13174b[this.f13173a] = i;
        this.f13175h[this.f13173a] = i2;
        this.f13176i[this.f13173a] = i3;
        if (i3 < this.f13181n) {
            this.f13181n = i3;
        }
        if (i3 > this.f13182o) {
        ...
        this.f13173a++;
        if (this.f13173a == this.f13180m) {
            int i4 = this.f13180m * 2;
            int[] iArr = new int[i4];
            int[] iArr2 = new int[i4];
            int[] iArr3 = new int[i4];
            for (int i5 = 0; i5 < this.f13173a; i5++) {
                iArr[i5] = this.f13174b[i5];
                iArr2[i5] = this.f13175h[i5];
                iArr3[i5] = this.f13176i[i5];
            }
            this.f13174b = iArr;
            this.f13175h = iArr2;
            this.f13176i = iArr3;
    ...
    public void mo2514a(File file, int i, int i2) {
        ...
        fileOutputStream.write(new byte[]{(byte) 35, (byte) 33, (byte) 65, (byte) 77, (byte) 82, (byte) 10}, 0, 6);
        int i4 = 0;
        for (i3 = 0; i3 < i2; i3++) {
            if (this.f13175h[i + i3] > i4) {
                i4 = this.f13175h[i + i3];
            }
        }
        byte[] bArr = new byte[i4];
        i4 = 0;
        for (i3 = 0; i3 < i2; i3++) {
            int i5 = this.f13174b[i + i3] - i4;
            int i6 = this.f13175h[i + i3];
            if (i5 >= 0) {
                if (i5 > 0) {
    ...
    void m20294a(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[][] iArr5) {
        iArr2[0] = ((((((((iArr[45] * 1) + (iArr[43] * 2)) + (iArr[41] * 4)) + (iArr[39] * 8)) + (iArr[37] * 16)) + (iArr[35] * 32)) + (iArr[33] * 64)) + (iArr[31] * 128)) + (iArr[29] * C0277j.f3694e);
        iArr2[1] = (((((iArr[242] * 1) + (iArr[79] * 2)) + (iArr[77] * 4)) + (iArr[75] * 8)) + (iArr[73] * 16)) + (iArr[71] * 32);
        iArr2[2] = ((((((((iArr[46] * 1) + (iArr[44] * 2)) + (iArr[42] * 4)) + (iArr[40] * 8)) + (iArr[38] * 16)) + (iArr[36] * 32)) + (iArr[34] * 64)) + (iArr[32] * 128)) + (iArr[30] * C0277j.f3694e);
        ...
        iArr5[1][4] = (((iArr[149] * 1) + (iArr[CtaButton.WIDTH_DIPS] * 2)) + (iArr[151] * 4)) + (iArr[117] * 8);
        ...
        iArr5[2][2] = (((iArr[158] * 1) + (iArr[159] * 2)) + (iArr[C0277j.f3691b] * 4)) + (iArr[110] * 8);
