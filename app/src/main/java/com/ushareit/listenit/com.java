...
public class com {
    ...
    public static List<String> m12033a(String str) {
    ...
    public static void m12034a(boolean z) {
        m12035a(z, "", new Object[0]);
    }

    public static void m12035a(boolean z, String str, Object... objArr) {
        if (!z) {
