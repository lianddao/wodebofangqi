...
public abstract class dpt extends Binder implements dps {
    public dpt() {
        attachInterface(this, "com.google.android.gms.common.internal.service.ICommonCallbacks");
    }

    public static dps m15237a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof dps)) ? new dpu(iBinder) : (dps) queryLocalInterface;
    }
