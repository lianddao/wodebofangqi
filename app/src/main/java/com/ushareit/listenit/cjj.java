...
public class cjj {
    ...
    public static final AtomicBoolean vd = new AtomicBoolean();
    private static final AtomicBoolean ve = new AtomicBoolean();

    @Deprecated
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        return cjb.m10875b().mo1288a(context, i, i2);
    }

    @Deprecated
    public static String getErrorString(int i) {
        return ConnectionResult.m2233a(i);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0148R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            cjk a = cjk.m11438a(context);
            if (i != 0) {
                if (a.m11439a(packageInfo, cjg.f8368a) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (a.m11439a(packageInfo2, a.m11439a(packageInfo, cjg.f8368a)) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                }
            } else if (a.m11439a(packageInfo2, cjg.f8368a) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
            if (cis.m11402a(packageInfo2.versionCode) < cis.m11402a(GOOGLE_PLAY_SERVICES_VERSION_CODE)) {
    ...
    public static boolean zzb(Context context, int i, String str) {
        return ciy.m11423a(context, i, str);
    }

    @Deprecated
    public static void zzbc(Context context) {
        int a = cjb.m10875b().mo1287a(context);
        if (a != 0) {
            Intent a2 = cjb.m10875b().mo1290a(context, a, "e");
            Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + a);
            if (a2 == null) {
                throw new cde(a);
            }
            throw new cdf(a, "Google Play Services not available", a2);
        }
    }
    ...
    private static void zzby(android.content.Context r7) {
        ...
        va = r0;	 Catch:{ NameNotFoundException -> 0x003a }
        r0 = com.ushareit.listenit.dqc.m15265b(r7);	 Catch:{ NameNotFoundException -> 0x003a }
        r1 = com.ushareit.listenit.cfe.m11074b(r7);	 Catch:{ NameNotFoundException -> 0x003a }
        vb = r1;	 Catch:{ NameNotFoundException -> 0x003a }
        r1 = "com.google.android.gms";
        r2 = 64;
        r0 = r0.m15264b(r1, r2);	 Catch:{ NameNotFoundException -> 0x003a }
        if (r0 == 0) goto L_0x0036;
    L_0x001b:
        r1 = com.ushareit.listenit.cjk.m11438a(r7);	 Catch:{ NameNotFoundException -> 0x003a }
        r2 = 1;
        r2 = new com.ushareit.listenit.cjd[r2];	 Catch:{ NameNotFoundException -> 0x003a }
        r3 = 0;
        r4 = com.ushareit.listenit.cjg.f8368a;	 Catch:{ NameNotFoundException -> 0x003a }
        r5 = 1;
        r4 = r4[r5];	 Catch:{ NameNotFoundException -> 0x003a }
        r2[r3] = r4;	 Catch:{ NameNotFoundException -> 0x003a }
        r0 = r1.m11439a(r0, r2);	 Catch:{ NameNotFoundException -> 0x003a }
        if (r0 == 0) goto L_0x0036;
    L_0x0030:
        r0 = 1;
        uZ = r0;	 Catch:{ NameNotFoundException -> 0x003a }
    L_0x0033:
        vc = r6;
    L_0x0035:
        return;
    ...
    L_0x0045:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.listenit.cjj.zzby(android.content.Context):void");
    }
    ...
    public static boolean zzf(Context context, int i) {
        return ciy.m11422a(context, i);
    }

    @Deprecated
    public static Intent zzfm(int i) {
        return cjb.m10875b().mo1290a(null, i, null);
    }
