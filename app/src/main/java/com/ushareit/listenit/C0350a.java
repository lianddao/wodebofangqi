...
public final class C0350a {
    private static final String f3978a = ("code_cache" + File.separator + "secondary-dexes");
    private static final Set<String> f3979b = new HashSet();
    private static final boolean f3980c = C0350a.m4950a(System.getProperty("java.vm.version"));

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m4947a(android.content.Context r6) {
        /*
        r4 = 20;
        r3 = 4;
        r0 = "MultiDex";
    ...
    L_0x001a:
        ...
        throw r0;
    L_0x0045:
        r0 = com.ushareit.listenit.C0350a.m4952b(r6);	 Catch:{ Exception -> 0x005d }
        if (r0 == 0) goto L_0x0015;
    L_0x004b:
        r1 = f3979b;	 Catch:{ Exception -> 0x005d }
        monitor-enter(r1);	 Catch:{ Exception -> 0x005d }
        r2 = r0.sourceDir;	 Catch:{ all -> 0x005a }
        r3 = f3979b;	 Catch:{ all -> 0x005a }
    ...
    L_0x00e9:
        ...
        goto L_0x0015;
    L_0x00f4:
        com.ushareit.listenit.C0350a.m4956c(r6);	 Catch:{ Throwable -> 0x0118 }
    L_0x00f7:
        r3 = new java.io.File;	 Catch:{ all -> 0x005a }
        r4 = r0.dataDir;	 Catch:{ all -> 0x005a }
        r5 = f3978a;	 Catch:{ all -> 0x005a }
        r3.<init>(r4, r5);	 Catch:{ all -> 0x005a }
        r4 = 0;
        r4 = com.ushareit.listenit.C0355f.m18666a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r5 = com.ushareit.listenit.C0350a.m4951a(r4);	 Catch:{ all -> 0x005a }
        if (r5 == 0) goto L_0x0121;
    L_0x010b:
        com.ushareit.listenit.C0350a.m4948a(r2, r3, r4);	 Catch:{ all -> 0x005a }
    L_0x010e:
        monitor-exit(r1);	 Catch:{ all -> 0x005a }
        r0 = "MultiDex";
        r1 = "install done";
    ...
    L_0x0121:
        ...
        r4 = 1;
        r0 = com.ushareit.listenit.C0355f.m18666a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r4 = com.ushareit.listenit.C0350a.m4951a(r0);	 Catch:{ all -> 0x005a }
        if (r4 == 0) goto L_0x0137;
    L_0x0133:
        com.ushareit.listenit.C0350a.m4948a(r2, r3, r0);	 Catch:{ all -> 0x005a }
        goto L_0x010e;
    L_0x0137:
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ushareit.listenit.a.a(android.content.Context):void");
    }

    private static ApplicationInfo m4952b(Context context) {
        try {
    ...
    static boolean m4950a(String str) {
        boolean z = false;
        if (str != null) {
    ...
    private static void m4948a(ClassLoader classLoader, File file, List<File> list) {
        if (!list.isEmpty()) {
            if (VERSION.SDK_INT >= 19) {
                C0352c.m10530b(classLoader, list, file);
            } else if (VERSION.SDK_INT >= 14) {
                C0351b.m7481b(classLoader, list, file);
            } else {
                C0353d.m13590b(classLoader, list);
            }
        }
    }

    private static boolean m4951a(List<File> list) {
        for (File a : list) {
            if (!C0355f.m18675a(a)) {
                return false;
            }
    ...
    private static Field m4953b(Object obj, String str) {
    ...
    private static Method m4954b(Object obj, String str, Class<?>... clsArr) {
        Class cls = obj.getClass();
        while (cls != null) {
            try {
    ...
    private static void m4955b(Object obj, String str, Object[] objArr) {
        Field b = C0350a.m4953b(obj, str);
    ...
    private static void m4956c(Context context) {
