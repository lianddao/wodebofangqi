...
public final class abk {
    public static Bitmap m5091a(Bitmap bitmap, Bitmap bitmap2, int i, int i2) {
        float f = 0.0f;
        if (bitmap2 == null) {
            return null;
        }
        ...
        if (bitmap == null) {
            bitmap = Bitmap.createBitmap(i, i2, m5090a(bitmap2));
        }
        m5095a(bitmap2, bitmap);
        new Canvas(bitmap).drawBitmap(bitmap2, matrix, new Paint(6));
        return bitmap;
    }

    public static Bitmap m5093a(Bitmap bitmap, ws wsVar, int i, int i2) {
        if (bitmap.getWidth() != i || bitmap.getHeight() != i2) {
            float min = Math.min(((float) i) / ((float) bitmap.getWidth()), ((float) i2) / ((float) bitmap.getHeight()));
            int width = (int) (((float) bitmap.getWidth()) * min);
            int height = (int) (((float) bitmap.getHeight()) * min);
            if (bitmap.getWidth() != width || bitmap.getHeight() != height) {
                Config a = m5090a(bitmap);
                Bitmap a2 = wsVar.mo3128a(width, height, a);
                if (a2 == null) {
    ...
    @TargetApi(12)
    public static void m5095a(Bitmap bitmap, Bitmap bitmap2) {
        if (VERSION.SDK_INT >= 12 && bitmap2 != null) {
            bitmap2.setHasAlpha(bitmap.hasAlpha());
        }
    }

    public static int m5089a(int i) {
        switch (i) {
            case 3:
            case 4:
                return 180;
    ...
    public static Bitmap m5092a(Bitmap bitmap, ws wsVar, int i) {
        Matrix matrix = new Matrix();
        m5094a(i, matrix);
        ...
        Config a = m5090a(bitmap);
        Bitmap a2 = wsVar.mo3128a(round, round2, a);
        if (a2 == null) {
    ...
    private static Config m5090a(Bitmap bitmap) {
        return bitmap.getConfig() != null ? bitmap.getConfig() : Config.ARGB_8888;
    }

    static void m5094a(int i, Matrix matrix) {
        switch (i) {
            case 2:
            ...
            case 6:
                ...
                return;
            case 7:
                matrix.setRotate(RadialCountdown.START_ANGLE);
                matrix.postScale(-1.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                return;
            case 8:
                matrix.setRotate(RadialCountdown.START_ANGLE);
