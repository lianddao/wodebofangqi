...
public class UnFollowArtist extends SoundboardRunnable<String> {
    ...
    class CollectionStreamHandler extends AbstractStreamHandler<String> {
        ...
        public String processInputStream(InputStream stream, long contentLength) throws StreamException {
            try {
                ...
                Logger.error(this, "Problems unfollowing artist", e);
            } catch (JSONException e2) {
                Logger.error(this, "Problems unfollowing artist", e2);
            }
            return null;
        }
    }

    public UnFollowArtist(SoundboardServer server, String soundBoardId, String artistId, SoundboardListener<String> listener) {
    ...
    public void run() {
        ...
        if (this.soundBoardId != null) {
            ...
            try {
                ...
                Logger.error(this, "Problems unfollowing artist", e);
                this.listener.onFailure("Problems unfollowing artist", e);
            }
