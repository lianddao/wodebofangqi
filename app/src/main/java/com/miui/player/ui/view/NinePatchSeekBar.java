...
public class NinePatchSeekBar extends SeekBar {
    public NinePatchSeekBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public NinePatchSeekBar(Context context) {
        super(context);
    }

    public NinePatchSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
